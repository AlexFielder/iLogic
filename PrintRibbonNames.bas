Attribute VB_Name = "PrintRibbonNames"
Public Sub PrintRibbon()
    Open "F:\Dropbox\iLogic\RibbonNames.txt" For Output As #1 '"C:\temp\RibbonNames.txt" For Output As #1
    ...
    MsgBox "Result written to: F:\Dropbox\iLogic\RibbonNames.txt"
End Sub
